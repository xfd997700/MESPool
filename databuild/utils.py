# -*- coding: utf-8 -*-
"""
Created on Thu Mar 17 10:16:47 2022
...
paths = {'bbbp': 'datasets/BBBP.csv',
         'bace': 'datasets/bace.csv',
         'clintox': 'datasets/clintox.csv',
         'hiv': 'datasets/HIV.csv',
         'tox21': 'datasets/tox21.csv',
         'esol': 'datasets/esol.csv',
         'freesolv': 'datasets/freesolv.csv',
         'lipo': 'datasets/Lipophilicity.csv',
         'muv': 'datasets/muv.csv',
         'sider': 'datasets/sider.csv',
         'qm7': 'datasets/qm7.csv',
         'qm8': 'datasets/qm8.csv',
         'qm9': 'datasets/qm9.csv',
         'covid': 'datasets/covid.csv',
         'muta': 'datasets/Mutagenicity.csv'}
