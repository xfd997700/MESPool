# -*- coding: utf-8 -*-
"""
Created on Fri Jan  6 14:38:14 2023
...
from databuild import TaskConfig, BaselineConfig, GenerateDataset, MolDatasetInMemory, RandomScaffoldSplit, RandomSplit, set_seed, LabelNormalizer
from process import Trainer
from models.MUSE_model import MUSEPred, EGINPred
from models.baseline import TopK, SAG
if __name__ == "__main__":  
    parser = argparse.ArgumentParser(description="EGIN test", add_help=True)
    ...
    parser.add_argument('--hidden_channels_e', type=int, default=64,
    ...
    loader_tr, loader_va, loader_te = RandomScaffoldSplit(dataset, task.smiles, k=args.k, drop_last=task.drop_last,
                                                              ...
                                                              null_value=0, frac_train=0.8, frac_valid=0.1, frac_test=0.1, num_workers=args.num_workers)
    ...
    for i in range(args.run_times):  
        ...
        for j in range(10):
            model = MUSEPred(in_channels_x = dataset.num_node_features,
                             in_channels_e = dataset.num_edge_features,
                             hidden_channels_x = args.hidden_channels_x,
                             hidden_channels_e = args.hidden_channels_e,
                             # out_channels_x = args.out_channels_x,
                             # out_channels_e = args.out_channels_e,
    ...
    np.save('results/npy/'+args.dataset+'_mes.npy', val)   
